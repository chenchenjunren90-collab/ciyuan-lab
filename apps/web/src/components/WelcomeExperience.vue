...
<template>
  <section class="welcome-experience" aria-labelledby="welcome-title">
    <header class="welcome-nav">
      ...
      <button class="welcome-settings" @click="emit('settings')" aria-label="打开外观设置"><span aria-hidden="true">Aa</span> 设置外观</button>
    </header>
    ...
    <main class="welcome-main">
      <div class="welcome-copy">
        ...
        <label class="welcome-name">
          ...
          <input v-model="name" maxlength="20" autocomplete="nickname" placeholder="新同学" @keyup.enter="startLearning" />
        </label>
        ...
        <div class="welcome-actions">
          <button class="welcome-primary" @click="startLearning">开始能力摸底 <b aria-hidden="true">→</b></button>
